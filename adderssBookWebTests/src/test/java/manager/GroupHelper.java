...
public class GroupHelper {
    ...
    public  void CreateGroup(GroupData group) {
        ...
        manager.driver.findElement(By.xpath("//label[contains(.,\'Group name:\')]")).click();
        manager.driver.findElement(By.name("group_name")).click();
        manager.driver.findElement(By.name("group_name")).sendKeys(group.name());
        manager.driver.findElement(By.xpath("//label[contains(.,\'Group header (Logo):\')]")).click();
        ...
        manager.driver.findElement(By.xpath("//label[contains(.,\'Group footer (Comment):\')]")).click();
